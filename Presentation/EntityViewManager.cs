...
public class EntityViewManager : MonoBehaviour
{
    ...
    [Header("ERA 1 — Units")]
    public string E1_Unit_Melee               = "Prefabs/Units/Soldier";
    ...
    {
        // Tail is "chapel_s" | "chapel_l" | "unique_bld" | "unique_unit"
        switch (sid)
        {
