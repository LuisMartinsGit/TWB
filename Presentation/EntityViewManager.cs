...
public class EntityViewManager : MonoBehaviour
{
    ...
    public string E1_Miner = "Prefabs/Units/Era1/Miner";
    ...
    string ResolveKeyFor(Entity e, out bool isBuilding, out UnitClass uClass)
    {
        ...
        if (hasU)
        {
            ...
            switch (ut.Class)
            {
                ...
                case UnitClass.Miner: return "e1/unit/miner";   // FIX: Added Miner
    ...
    GameObject CreateFallbackUnit(UnitClass uClass)
    {
        ...
        switch (uClass)
        {
            ...
            case UnitClass.Siege:
                ...
                break;
            // FIX: Added missing cases for Economy, Miner, Scout
            case UnitClass.Economy:
                go = GameObject.CreatePrimitive(PrimitiveType.Capsule);
                go.name = "Unit_Fallback_Builder";
                go.transform.localScale = new Vector3(0.7f, 1.0f, 0.7f);
                break;
            case UnitClass.Miner:
                go = GameObject.CreatePrimitive(PrimitiveType.Capsule);
                go.name = "Unit_Fallback_Miner";
                go.transform.localScale = new Vector3(0.7f, 1.0f, 0.7f);
                break;
            case UnitClass.Scout:
                go = GameObject.CreatePrimitive(PrimitiveType.Capsule);
                go.name = "Unit_Fallback_Scout";
                go.transform.localScale = new Vector3(0.5f, 1.1f, 0.5f);
                break;
