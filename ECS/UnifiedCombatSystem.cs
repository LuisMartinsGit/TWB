...
public partial struct UnifiedCombatSystem : ISystem
{
    ...
    public void OnUpdate(ref SystemState state)
    {
        ...
        foreach (var (transform, faction, lineOfSight, entity) in SystemAPI
            ...
            .WithNone<Target>()
            .WithNone<UserMoveOrder>()  // NEW: Skip auto-targeting if user commanded movement
            .WithEntityAccess())
        {
            if (em.HasComponent<DesiredDestination>(entity))
            {
            ...
            .WithEntityAccess())
        {
            ...
            {
                // FIRST: Check if there are any enemies in line of sight
                ...
                if (nearestEnemy != Entity.Null)
                {
                    ...
                    // Add AttackCommand to maintain engagement
                ...
                // ONLY if no enemies found: Return to guard point
