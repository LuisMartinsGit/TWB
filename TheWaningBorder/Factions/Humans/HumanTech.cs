...
namespace TheWaningBorder.Factions.Humans
{
    [DefaultExecutionOrder(-10000)]
    public sealed class HumanTech : MonoBehaviour
    {
        public static HumanTech Instance { get; private set; }
        ...
        public static void EnsureTechTreeDB()
        {
            ...
            var go = new GameObject("HumanTechTree");
